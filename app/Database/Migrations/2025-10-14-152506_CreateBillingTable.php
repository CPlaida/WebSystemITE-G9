...
class CreateBillingTable extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            // PhilHealth-related fields (embedded for clean remigration)
            'philhealth_member'            => ['type' => 'TINYINT', 'constraint' => 1, 'null' => true],
            'philhealth_suggested_amount'  => ['type' => 'DECIMAL', 'constraint' => '10,2', 'null' => true],
            'philhealth_approved_amount'   => ['type' => 'DECIMAL', 'constraint' => '10,2', 'null' => true],
            'philhealth_codes_used'        => ['type' => 'TEXT', 'null' => true],
            'philhealth_rate_ids'          => ['type' => 'TEXT', 'null' => true],
            'philhealth_verified_by'       => ['type' => 'VARCHAR', 'constraint' => 20, 'null' => true],
            'philhealth_verified_at'       => ['type' => 'DATETIME', 'null' => true],
            // Source fields to derive suggestion (if not stored elsewhere)
            'primary_icd10_code'           => ['type' => 'VARCHAR', 'constraint' => 20, 'null' => true],
            'primary_rvs_code'             => ['type' => 'VARCHAR', 'constraint' => 20, 'null' => true],
