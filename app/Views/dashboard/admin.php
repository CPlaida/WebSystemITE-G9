...
<?= $this->section('sidebar') ?>
    ...
    <li class="nav-item expandable">
        ...
        <ul class="submenu">
            <li><a href="#"><i class="fas fa-user-plus"></i> Register Patient</a></li>
            <li><a href=""><i class="fas fa-user-edit"></i> View Patient</a></li>
        </ul>
    </li>
    ...
    <li class="nav-item expandable">
        ...
        <ul class="submenu">
            <li><a href="#"><i class="fas fa-plus"></i> Book Appointment</a></li>
            <li><a href="#"><i class="fas fa-list"></i> Appointment List</a></li>
        </ul>
    </li>
    ...
    <li class="nav-item expandable">
        ...
        <ul class="submenu">
            <li><a href="#"><i class="fas fa-file-invoice"></i> Bill Management</a></li>
            <li><a href="#"><i class="fas fa-chart-line"></i> Billing Process</a></li>
        </ul>
    </li>
