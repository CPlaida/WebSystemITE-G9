...
<?= $this->section('content') ?>
  ...
  <?php if (!empty($testResult['result_file_url'])): ?>
  <div class="info-group" style="margin-top: 1rem;">
    <div class="section-title">Analyzer Output</div>
    ...
    <small class="form-text text-muted" style="display:block;margin-top:0.35rem;">This is the original file generated by the lab equipment.</small>
  </div>
  <?php endif; ?>
                ...
                <div class="info-group">
                    <?php if (!empty($testResult['result_file_url'])): ?>
                        <div class="info-value" style="text-align: center;">
                            Analyzer results are available in the uploaded file.<br>
