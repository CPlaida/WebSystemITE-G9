...
<?= $this->section('title') ?>Female Ward – Room & Bed Management<?= $this->endSection() ?>

<?= $this->section('content') ?>
<div class="container-fluid py-4">
  <div class="composite-card billing-card" style="margin-top:0;">
    <div class="composite-header">
      <h1 class="composite-title">Female Ward – Room & Bed Management</h1>
    </div>
    <div class="card-body">
      <p class="mb-3">This is a placeholder page for managing rooms and beds in the Female Ward. The data below is sample only.</p>
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr>
            ...
            <td>Ready for new admission</td>
          </tr>
          <tr>
            <td>F-301</td>
            <td>Bed 2</td>
            <td><span class="badge badge-danger">Occupied</span></td>
            <td>Patient on IV antibiotics</td>
          </tr>
          <tr>
            <td>F-302</td>
            <td>Bed 1</td>
